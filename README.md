...
The project is intentionally simple: no build step, no dependencies, no framework. Vanilla HTML, CSS, and JavaScript on the front end; a single ES module serverless function on the back end.
